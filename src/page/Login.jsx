    ...
    <div className="bg">
      ...
      <div className="container">
        ...
        <form action="">
          ...
          <input className="form-control" type="password" name="password" id="password" onChange={handlePasswordChange} placeholder="password" />
          <div className="form-check">
            <input className="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked/>
            <p className="form-check-label" to="flexCheckDefault">Remember Me!</p>
          </div>
