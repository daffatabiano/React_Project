            ...
            <div className="container-fluid">
                ...
                <div className="d-flex justify-content-end align-items-center p-2">
                    <button type="button" className="button"
                        data-bs-toggle="popover" data-bs-title="Notifications" data-bs-content="And here's some amazing content. It's very engaging. Right?"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-bell" viewBox="0 0 16 16">
